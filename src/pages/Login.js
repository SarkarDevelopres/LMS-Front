...
function Login({action}) {
  ...
  if (action == "Log-In") {
    ...
    <input name='pass' type='password' placeholder='Password' value={logData.password} onChange={handleSubmit}/><button className={styles.submit} onClick={login}>{action}</button></div>
  } else {
